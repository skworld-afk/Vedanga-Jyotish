      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex flex-1 justify-center items-center gap-2 lg:gap-6">
            ...
            <Link href="/learn/astrology" className="px-3 lg:px-5 py-2.5 rounded-full text-xs lg:text-sm font-bold tracking-widest uppercase text-white/90 hover:text-white hover:bg-white/20 transition-all duration-300 hover:-translate-y-0.5 active:scale-95 drop-shadow-sm">Learn Astrology</Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-[#FF6347] border-t border-orange-600/30">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 shadow-inner">
            ...
            <Link href="/learn/astrology" onClick={() => setIsMenuOpen(false)} className="block px-3 py-2 rounded-md text-sm font-bold uppercase tracking-widest text-white hover:bg-white/20 transition-colors">Learn Astrology</Link>
