                ...
                {users.map((user) => (
                  <li key={user.id} className="p-4 bg-zinc-900 rounded-xl border border-zinc-800 hover:border-zinc-700 flex flex-col sm:flex-row sm:items-center justify-between gap-4 transition-all shadow-sm hover:shadow-md">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        <button type="submit" className="px-3 py-1.5 bg-red-500/10 text-red-500 border border-red-500/20 text-xs font-semibold uppercase tracking-wider rounded-lg hover:bg-red-500/20 hover:border-red-500/30 transition-all shadow-sm">
                          Delete
                        </button>
                      </DeleteForm>
                    </div>
                ...
                {profiles.map((profile) => (
                  <li key={profile.id} className="p-4 bg-zinc-900 rounded-xl border border-zinc-800 hover:border-zinc-700 flex flex-col sm:flex-row sm:items-center justify-between gap-4 transition-all shadow-sm hover:shadow-md">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        <button type="submit" className="flex items-center gap-1 px-3 py-1.5 bg-red-500/10 text-red-500 border border-red-500/20 text-xs font-semibold uppercase tracking-wider rounded-lg hover:bg-red-500/20 hover:border-red-500/30 transition-all shadow-sm">
                          Delete
                        </button>
                      </DeleteForm>
                    </div>
